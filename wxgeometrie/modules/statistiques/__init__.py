...
class Statistiques(Panel_API_graphique):
    ...
    def __init__(self, *args, **kw):
        ...
        self._tile1 = QLabel(u" 1er Quartile:")
	self._mediane = QLabel(u" Médiane:")
        self._tile3 = QLabel(u" 3ème Quartile:")
        ...
        bsizer.addWidget(self._tile1)
	bsizer.addWidget(self._mediane)
        bsizer.addWidget(self._tile3)
...
##
    ...
    def calculer(self):
        ...
        self._tile1.setText(u" 1er quartile: " + str(self.tile(4, 1)))
	self._mediane.setText(u" Médiane: " + str(self.mediane()))
        self._tile3.setText(u" 3ème quartile: " + str(self.tile(4, 3)))
